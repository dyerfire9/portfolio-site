...
export default [
    ...
    {
        title: 'TicTacToe',
        description: 'A 2-Player stratagy Game for Android',
        features: ['Simple and interactive UI',
                   'Points based sytem to keep track of which player is winning',
                   'Ability to reset game and clear board as needed'],
    ...
    },
    {
        ...
        features: ['Quickly & Efficiently do simple arithmatic calculations',
